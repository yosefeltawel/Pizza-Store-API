		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderPizzaEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public OrderPizzaEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<OrderPizzaEntity, EntityCollection<PizzaWithToppingEntity>>("PizzaWithToppings", a => a._pizzaWithToppings, (a, b) => a._pizzaWithToppings = b, a => a.PizzaWithToppings, () => new OrderPizzaRelations().PizzaWithToppingEntityUsingOrderPizzaId, typeof(PizzaWithToppingEntity), (int)PizzaStore.Data.EntityType.PizzaWithToppingEntity);
		...
		public virtual EntityCollection<PizzaWithToppingEntity> PizzaWithToppings { get { return GetOrCreateEntityCollection<PizzaWithToppingEntity, PizzaWithToppingEntityFactory>("OrderPizza", true, false, ref _pizzaWithToppings); } }
...
namespace PizzaStore.Data.RelationClasses
{
	...
	{
		/// <summary>Returns a new IEntityRelation object, between OrderPizzaEntity and PizzaWithToppingEntity over the 1:n relation they have, using the relation between the fields: OrderPizza.Id - PizzaWithTopping.OrderPizzaId</summary>
		public virtual IEntityRelation PizzaWithToppingEntityUsingOrderPizzaId
		{
			get { return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.OneToMany, "PizzaWithToppings", true, new[] { OrderPizzaFields.Id, PizzaWithToppingFields.OrderPizzaId }); }
		}
	...
	{
		internal static readonly IEntityRelation PizzaWithToppingEntityUsingOrderPizzaIdStatic = new OrderPizzaRelations().PizzaWithToppingEntityUsingOrderPizzaId;
